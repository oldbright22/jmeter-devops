package com.jmeter.devops.testrunner;

import com.jmeter.devops.configuration.JMeterArgumentsArray;
import com.jmeter.devops.configuration.JMeterProcessJVMSettings;
import com.jmeter.devops.configuration.RemoteArgumentsArrayBuilder;
import com.jmeter.devops.configuration.RemoteConfiguration;
import com.jmeter.devops.utility.StreamRedirector;
...
import static com.jmeter.devops.utility.UtilityFunctions.isNotSet;
...
public class TestManager {
    ...
    private String executeSingleTest(File test, JMeterArgumentsArray testArgs) throws MojoExecutionException {
        ...
        argumentsArray.addAll(RemoteArgumentsArrayBuilder.buildRemoteArgumentsArray(remoteServerConfiguration.getPropertiesMap()));
